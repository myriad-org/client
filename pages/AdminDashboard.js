...
export default function AdminDashboard() {
    ...
    const handleVerificationClick = async () => {
        const contractAdmin = await getAdmin()
        // console.log(contractAdmin)
        // console.log(account)
        // console.log(contractAdmin === account)
        if (
            contractAdmin.toString().toLowerCase() ===
            ...
            dispatch({
                ...
                message:
                    "Adminship Successfully Verified. You can now perform following functions",
                position: "bottomL",
            })
            setIsAdmin(true)
        } else {
            dispatch({
                ...
                message: `As per our records ${contractAdmin} is the Admin of this smart contract.`,
                position: "bottomL",
                isClosing: false,
            })
        }
